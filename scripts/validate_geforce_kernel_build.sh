...
echo "  PEARL_GEMM_KERNEL=geforce_v1 ./build/propminer --self-test --rtx5090 --gpus 0"
echo "  (unset PEARL_GEMM_KERNEL)    ./build/propminer --self-test --rtx5090 --gpus 0  # v2 default"
echo ""
echo "PRODUCTION: GeForce v2 is default when built (unset PEARL_GEMM_KERNEL)."
echo "Rollback: PEARL_GEMM_KERNEL=geforce_v1 or consumer (no rebuild)."
