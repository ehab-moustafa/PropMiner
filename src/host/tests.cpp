...
static void test_bincode_plain_proof_header_and_roots() {
    ...
    EXPECT(proof_v2.size() == proof.size());
    EXPECT(std::memcmp(proof_v2.data(), proof.data(), proof.size()) == 0);
